...
public class ItemViewDelegateManager<T> {
    ...
    public ItemViewDelegateManager<T> addDelegate(int viewType, ItemViewDelegate<T> delegate) {
        if (delegates.get(viewType) != null) {
            throw new IllegalArgumentException("An ItemViewDelegate is already registered for the viewType = "
                    + viewType
                    + ". Already registered ItemViewDeleaget is " +
    ...
    public void convert(ViewHolder holder, T item, int position) {
        ...
        throw new IllegalArgumentException("No ItemViewDelegateManager added that matches positioin=" + position + "in data source");
    }
