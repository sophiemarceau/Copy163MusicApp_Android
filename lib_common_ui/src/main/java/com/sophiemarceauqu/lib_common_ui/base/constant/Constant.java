package com.sophiemarceauqu.lib_common_ui.base.constant;
...
public class Constant {
    ...
    public static String[] WRITE_READ_EXTERNAL_PERMISSION = new String[]{
            Manifest.permission.WRITE_EXTERNAL_STORAGE, Manifest.permission.READ_EXTERNAL_STORAGE
    };

    public static final int HARDWEAR_CAMERA_CODE = 0x02;
    public static final String[] HANDWEAR_CAMERA_PERMISSION = new String[]{Manifest.permission.CAMERA};
